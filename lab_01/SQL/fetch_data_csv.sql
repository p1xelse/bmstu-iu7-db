...
COPY public.deliveries (consumer_id, order_id, status, payment_method_) FROM '/home/generate/deliveries.csv' DELIMITER ';' CSV HEADER;
...
COPY public.products_warehouse (warehouse_id, products_id) FROM '/home/generate/warehouses_products.csv' DELIMITER ';' CSV HEADER;